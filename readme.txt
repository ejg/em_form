...
example_form is an example form with model, view and controller that shows how Em_Form works.

To get the CSS to work, move css/form.css to media/css/form.css